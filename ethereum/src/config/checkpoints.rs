...
pub const CHECKPOINT_SYNC_SERVICES_LIST: &str = "https://raw.githubusercontent.com/crosschain-alliance/helios/tree/feat/lukso-backup/checkpoint.yaml";
